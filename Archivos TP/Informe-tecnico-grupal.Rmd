...
```{r}
# Muestra de resultados
full_join(x = df_barrio, y = bu_barrio, by = "BARRIO")
```
...
## CREANDO NUEVA VARIABLE 12.1.1.
Utilizando los datos de las columnas 5.1, 6.1 y 7.1, construimos una nueva variable que indica la cantidad de servicios formales que tiene cada hogar.
